...
height:300px;   width: 101%">
	<?php
	 ...
	 echo "<th scope='col'>DESCONFIRMAR</th>"; 
	 echo "</tr>","</thead>","</center>";
	 

     $result = mysqli_query($conexion, "SELECT * FROM confirmados  order by fechaconfirma desc, hora"); 
	 ...
	 {	 
	     while($row =  mysqli_fetch_array($result)) 
	     {
			...
			echo "<td title='DESCONFIRMAR'><center><a href='confirmar2.php?cod=$row[0]&cod1=$row[14]' ><IMG type=image src='images/images.png' /></a></center></td>";
		    echo "</tr>";
		 }
	 }
	?>
