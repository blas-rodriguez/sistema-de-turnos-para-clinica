...
height:300px;   width: 101%">
	<?php
	 ...
	 echo "<th scope='col'>NOMBRE DE USUARIO </th>";//encabezado
	 ...
	 {	 
	     while($row =  mysqli_fetch_array($result)) 
	     {
			...
			echo "<td >$row[4]</td>";
		echo "<td title='ELIMINAR'><center><a onclick='return confirmDel();'  href='eliminar.php?cod=0&reg=$row[0]' ><IMG src='images/eliminar-cancelar-icono-4935-16.png' /></a></center></center></td>";?>
		<td title="MODIFICAR"><center><a href="javascript:abrir('<?php echo "modificarus.php?cod=$row[0]&pr=$row[1]&es=$row[2]&ni=$row[3]&mail=$row[4]"; ?>')"><input type=image src="images/modificar.png" /></a></center></td>
		  <?php   echo "</tr>";
		 }
		 //echo "<td style='background-color: BLUE;' title='AGREGAR UN USUARIO'><center><input type=image src='images/agregar1.png' /></center></td>";
	 }
	?>
</div>
<td style="background-color: BLUE;" title="AGREGAR UN USUARIO"><center><a href="javascript:abrir('registrous.php')"><img src="images/agregar1.png"></a></center>
