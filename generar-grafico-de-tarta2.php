	...
	//PADRON TOTAL
	 //$consulta=mysqli_query($conexion,"SELECT * FROM legajo ");
       // while($dato= mysqli_fetch_array($consulta)){
		$sql11="SELECT * from turnos  WHERE fecha BETWEEN '".$desde1."' AND '".$hasta1."' and codesp='".$sp."'";
		$result11 = $conexion->query($sql11);
		$combobit11 = mysqli_num_rows($result11);
		$num1 = (int)$combobit11; 
		//$num1 = 50; 
	//CANTIDAD DE ACTIVOS
	    $sql22="SELECT * from turnos  WHERE  fecha BETWEEN '".$desde1."' AND '".$hasta1."' and codesp='".$sp."' and estado=2";
		$result22 = $conexion->query($sql22);
		$combobit22 = mysqli_num_rows($result22); 
		$num2 = (int)$combobit22;
		//$num2 = 50;
		//CANTIDAD DE BAJAS
	    $sql33="SELECT * from turnos  WHERE  fecha BETWEEN '".$desde1."' AND '".$hasta1."' and codesp='".$sp."' and not estado=2";
