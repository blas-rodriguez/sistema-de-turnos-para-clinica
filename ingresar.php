	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="active"><a href="ingresar.php" accesskey="5" title="">Ingresar</a></li>
			</ul>
		</div>
	</div>
			  ...
			  <table  border='1'   CELLPADDING=0  CELLSPACING=10>
				...
				<td >
				  <form  action='log.php' method='post'>
						...
						<input type="text" id="Name" name="usuario" style"text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"/><br /><br />
						<label for="Name">CONTRASEÑA:</label>
						<input type="password" id="Name" name="pass" /><br />
