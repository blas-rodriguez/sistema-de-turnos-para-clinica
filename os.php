...
height:300px;   width: 101%">
	<?php
	 ...
	 echo "<th scope='col'>OBRA SOCIAL </th>";//encabezado
     ...
     $result = mysqli_query($conexion, "SELECT * FROM os  "); 
	 ...
	 {	 
		...
		<td title="MODIFICAR"><center><a href="javascript:abrir('<?php echo "modificaros.php?cod=$row[0]&pr=$row[1]&es=$row[2]"; ?>')"><input type=image src="images/modificar.png" /></a></center></td>
		  <?php  
		  echo "</tr>";
		 }
...
<td style="background-color: BLUE;" title="AGREGAR UNA OBRA SOCIAL"><center><a href="javascript:abrir('registroos.php')"><img src="images/agregar1.png"></a></center>
	</td >
   </tr>
    </table >
